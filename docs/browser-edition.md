...
Use the [live workbench](https://biocanse.github.io/philadelphia-assessment-group-explorer/) or download the [browser ZIP](https://github.com/BIOcanse/philadelphia-assessment-group-explorer/releases/download/v1.0.0/group-explorer-browser-v1.0.0.zip).
