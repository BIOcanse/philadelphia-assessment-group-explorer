...
def package_ui():
    ...
    for name in ['index.html','app.js','styles.css','research.js','research.css','research-data.json','research-data.json.gz','research-sources.zip','research-story.html','research-story-sources.zip']:
